...
结束时间不能小于开始时间，结束时间和开始时间的间隔不能超过7天
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->btime,"btime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->etime,"etime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->queryIds,"queryIds");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->queryIds,30,"queryIds");
	}
