...
1、商品质量问题，2、收到的商品不符，3、协商一致退款，4、买家一直未收到货，5、退还多付邮费，6、折扣、赠品、发票等问题，0、其它
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->isReturnGoods,"isReturnGoods");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->isReturnPostFee,"isReturnPostFee");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->refundDesc,"refundDesc");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->refundReasonId,"refundReasonId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->returnFee,"returnFee");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->subOrderId,"subOrderId");
	}
