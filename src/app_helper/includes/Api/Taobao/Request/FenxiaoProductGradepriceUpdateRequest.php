...
class FenxiaoProductGradepriceUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->ids,200,"ids");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->prices,"prices");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->prices,200,"prices");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->productId,"productId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->targetType,"targetType");
	}
