...
class TsPropertyGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->serviceItemCode,"serviceItemCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->serviceItemCode,64,"serviceItemCode");
	}
