...
{"bar":false,"catv":false,"ddd":false,"idd":false,"pubtoilet":false,"toilet":false}
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->area,1,"area");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->bbn,1,"bbn");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->bedType,"bedType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->bedType,1,"bedType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->breakfast,"breakfast");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->breakfast,1,"breakfast");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->deposit,99999900,"deposit");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->deposit,0,"deposit");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->desc,"desc");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->desc,50000,"desc");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->fee,99999900,"fee");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->fee,0,"fee");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->guide,300,"guide");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->hid,"hid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->paymentType,"paymentType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->paymentType,1,"paymentType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->priceType,1,"priceType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rid,"rid");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->siteParam,100,"siteParam");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->size,1,"size");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->storey,8,"storey");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->title,90,"title");
	}
