...
默认是需要授权
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->alarmNumber,"alarmNumber");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->haveGuarantee,"haveGuarantee");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->haveInvoice,"haveInvoice");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->name,"name");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->postageType,"postageType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->productcatId,"productcatId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->prov,"prov");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->quantity,"quantity");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->retailPriceHigh,"retailPriceHigh");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->retailPriceLow,"retailPriceLow");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->standardPrice,"standardPrice");
	}
