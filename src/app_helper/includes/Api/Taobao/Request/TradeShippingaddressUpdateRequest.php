...
class TradeShippingaddressUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverAddress,228,"receiverAddress");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverCity,32,"receiverCity");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverDistrict,32,"receiverDistrict");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverMobile,30,"receiverMobile");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverName,50,"receiverName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverPhone,30,"receiverPhone");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverState,32,"receiverState");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->receiverZip,6,"receiverZip");
