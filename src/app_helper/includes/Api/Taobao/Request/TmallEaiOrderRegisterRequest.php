...
1:JIP用户
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->action,"action");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->eventName,"eventName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->eventName,50,"eventName");
