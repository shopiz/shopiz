...
class FenxiaoCooperationTerminateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->cooperateId,"cooperateId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endRemainDays,"endRemainDays");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endRemark,"endRemark");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->endRemark,2000,"endRemark");
	}
