...
class WeitaoCloudtagsGroupCustomAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->groupDesc,256,"groupDesc");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->userListFileContent,"userListFileContent");
	}
