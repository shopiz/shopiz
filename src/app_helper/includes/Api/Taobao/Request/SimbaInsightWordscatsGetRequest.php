...
词^^类目
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->filter,"filter");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->wordCategories,"wordCategories");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->wordCategories,200,"wordCategories");
	}
