...
class AlipayPointOrderAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderTime,"orderTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->pointCount,"pointCount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->userSymbol,"userSymbol");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->userSymbolType,"userSymbolType");
	}
