...
class RefundGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->refundId,9223372036854775807,"refundId");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->refundId,1,"refundId");
	}
