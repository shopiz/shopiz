...
class AlipaySystemOauthTokenRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->code,40,"code");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->grantType,"grantType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->grantType,20,"grantType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->refreshToken,40,"refreshToken");
	}
