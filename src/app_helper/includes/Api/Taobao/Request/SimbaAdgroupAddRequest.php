...
class SimbaAdgroupAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->defaultPrice,"defaultPrice");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->defaultPrice,5,"defaultPrice");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->imgUrl,"imgUrl");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemId,"itemId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->title,40,"title");
	}
