...
0：按章节售卖 1：按千字售卖
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->author,60,"author");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->cid,"cid");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->cid,0,"cid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->copyrightEnd,"copyrightEnd");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->copyrightFiles,"copyrightFiles");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->cover,"cover");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sellWay,"sellWay");
