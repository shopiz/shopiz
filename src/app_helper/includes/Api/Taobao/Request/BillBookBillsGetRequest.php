...
class BillBookBillsGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->accountId,"accountId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endTime,"endTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->fields,"fields");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->fields,300,"fields");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->journalTypes,10,"journalTypes");
