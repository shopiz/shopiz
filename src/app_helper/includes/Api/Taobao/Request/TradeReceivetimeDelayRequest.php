...
class TradeReceivetimeDelayRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->days,"days");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->days,10,"days");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->days,3,"days");
