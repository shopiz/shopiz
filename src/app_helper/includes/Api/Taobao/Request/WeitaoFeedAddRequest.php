...
class WeitaoFeedAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->coverPic,"coverPic");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->coverPic,1000,"coverPic");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->jsonTiles,3000,"jsonTiles");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->link,256,"link");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->linkDesc,22,"linkDesc");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->title,64,"title");
	}
