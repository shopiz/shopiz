...
class TravelItemsAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->comboPriceCalendar,"comboPriceCalendar");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->desc,"desc");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->duration,"duration");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->props,"props");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->prov,"prov");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->refundRegulation,"refundRegulation");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->sellerCids,20,"sellerCids");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->sellerCids,256,"sellerCids");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuPrices,380,"skuPrices");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuProperties,380,"skuProperties");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuQuantities,380,"skuQuantities");
