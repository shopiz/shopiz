...
class CrmMembersSearchRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->buyerNick,1000,"buyerNick");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->currentPage,"currentPage");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->currentPage,1000,"currentPage");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->currentPage,1,"currentPage");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->grade,4,"grade");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->grade,-1,"grade");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->maxCloseTradeNum,0,"maxCloseTradeNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->maxItemNum,0,"maxItemNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->maxTradeCount,0,"maxTradeCount");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->minCloseTradeNum,0,"minCloseTradeNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->minItemNum,0,"minItemNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->minTradeCount,0,"minTradeCount");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageSize,100,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageSize,1,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->province,35,"province");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->province,1,"province");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->relationSource,3,"relationSource");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->relationSource,1,"relationSource");
	}
