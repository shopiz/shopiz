...
5、由于3和4的原因所以当是货到付款用户或保障速递用户时如果没填写对应的运送方式express是必须填写的
 ...
 <br>3:表示按宝贝体积计算运费
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->assumer,"assumer");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->name,"name");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->name,50,"name");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateAddFees,"templateAddFees");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateAddStandards,"templateAddStandards");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateDests,"templateDests");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateStartFees,"templateStartFees");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateStartStandards,"templateStartStandards");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->templateTypes,"templateTypes");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->valuation,"valuation");
	}
