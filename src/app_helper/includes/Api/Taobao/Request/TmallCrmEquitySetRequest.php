...
class TmallCrmEquitySetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->excludeArea,4,"excludeArea");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->grade,"grade");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->grade,4,"grade");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->point,4,"point");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->postage,4,"postage");
	}
