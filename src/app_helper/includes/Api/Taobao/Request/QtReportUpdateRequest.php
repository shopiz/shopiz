...
3.已出具报告<br /> 支持最大值为：4<br /> 支持最小值为：0
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->extAttr,2000,"extAttr");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemDesc,"itemDesc");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->itemDesc,150,"itemDesc");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemUrl,"itemUrl");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->itemUrl,256,"itemUrl");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->itemUrl,256,"itemUrl");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->message,300,"message");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->nick,"nick");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->nick,32,"nick");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->qtCode,"qtCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->qtCode,64,"qtCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->qtName,"qtName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->qtName,150,"qtName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->qtStandard,16,"qtStandard");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->qtType,"qtType");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->qtType,15,"qtType");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->qtType,0,"qtType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->reportUrl,256,"reportUrl");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->servcieItemCode,"servcieItemCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->servcieItemCode,64,"servcieItemCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->spName,"spName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->spName,50,"spName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->status,"status");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->status,4,"status");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->status,0,"status");
	}
