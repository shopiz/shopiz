...
多个编号用英文符号的逗号隔开。最多支持50个经销采购单编号的查询。
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->dealerOrderIds,"dealerOrderIds");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->dealerOrderIds,50,"dealerOrderIds");
	}
