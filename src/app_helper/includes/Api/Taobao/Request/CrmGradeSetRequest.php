...
950即9.5折，888折即8.88折。出于安全原因，折扣现最低只能设置到700即7折。<br /> 支持最大值为：1000<br /> 支持最小值为：700
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->amount,4,"amount");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->count,4,"count");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->discount,"discount");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->discount,4,"discount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->grade,"grade");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->grade,4,"grade");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->hierarchy,"hierarchy");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->hierarchy,4,"hierarchy");
	}
