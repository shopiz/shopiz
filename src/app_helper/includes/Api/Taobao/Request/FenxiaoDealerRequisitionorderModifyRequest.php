...
class FenxiaoDealerRequisitionorderModifyRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->dealerOrderId,"dealerOrderId");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->deleteDetailIds,50,"deleteDetailIds");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->detailIdPrices,50,"detailIdPrices");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->detailIdQuantities,50,"detailIdQuantities");
	}
