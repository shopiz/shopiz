...
1:JIP用户。
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->callBackUrl,"callBackUrl");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->email,"email");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->mobile,"mobile");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->principal,"principal");
