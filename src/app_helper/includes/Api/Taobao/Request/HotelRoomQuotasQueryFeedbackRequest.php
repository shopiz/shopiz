...
F:失败
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->avaliableRoomCount,"avaliableRoomCount");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->avaliableRoomCount,0,"avaliableRoomCount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->checkinDate,"checkinDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->checkoutDate,"checkoutDate");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->totalRoomPrice,"totalRoomPrice");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->totalRoomPrice,99999999,"totalRoomPrice");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->totalRoomPrice,0,"totalRoomPrice");
	}
