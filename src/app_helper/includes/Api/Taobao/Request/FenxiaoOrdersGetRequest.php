...
sub_purchase_orders表示只返回子采购单列表
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageNo,2147483647,"pageNo");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageNo,-21474836478,"pageNo");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageSize,2147483647,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageSize,-21474836478,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->purchaseOrderId,9223372036854775807,"purchaseOrderId");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->purchaseOrderId,-9223372036854775808,"purchaseOrderId");
	}
