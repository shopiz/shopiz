...
class HotelSoldOrdersIncrementGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endModified,"endModified");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->startModified,"startModified");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->status,1,"status");
	}
