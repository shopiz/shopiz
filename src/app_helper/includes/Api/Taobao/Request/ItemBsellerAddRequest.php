...
如果是二手商品，特定类目下属性里面必填新旧成色属性
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->auctionPoint,"auctionPoint");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->features,4000,"features");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->num,999999,"num");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuPrices,1000,"skuPrices");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->type,100,"type");
	}
