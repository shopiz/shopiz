...
AUTO_CALCULATE:自动计算可供扣减，如果库存不够返回失败 ClIENT_FORCE：强制要求最大化扣减，有多少扣多少
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->bizType,"bizType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->bizUniqueCode,"bizUniqueCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->items,"items");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->operateTime,"operateTime");
