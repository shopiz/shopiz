...
5:粉红色<br /> 支持最大值为：5<br /> 支持最小值为：1
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->supplierMemoFlag,"supplierMemoFlag");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->supplierMemoFlag,5,"supplierMemoFlag");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->supplierMemoFlag,1,"supplierMemoFlag");
	}
