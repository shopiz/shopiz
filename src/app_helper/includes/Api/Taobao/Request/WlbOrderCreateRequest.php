...
如果某一个字段的数据为空时，必须传NA
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->buyerNick,64,"buyerNick");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->isFinished,"isFinished");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderItemList,"orderItemList");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderSubType,"orderSubType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderType,"orderType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->outBizCode,"outBizCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->outBizCode,128,"outBizCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->remark,4000,"remark");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->storeCode,"storeCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->storeCode,64,"storeCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->tmsServiceCode,64,"tmsServiceCode");
	}
