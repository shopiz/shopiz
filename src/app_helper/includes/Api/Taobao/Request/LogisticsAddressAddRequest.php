...
<br><font color='red'>如果所在地区是海外的可以为空，否则为必参</font>
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->contactName,"contactName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->memo,256,"memo");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->province,"province");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->sellerCompany,20,"sellerCompany");
	}
