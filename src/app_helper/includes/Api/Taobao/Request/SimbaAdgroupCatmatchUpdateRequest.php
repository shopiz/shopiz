...
class SimbaAdgroupCatmatchUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->catmatchId,"catmatchId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->maxPrice,"maxPrice");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->maxPrice,5,"maxPrice");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->onlineStatus,"onlineStatus");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->useDefaultPrice,"useDefaultPrice");
	}
