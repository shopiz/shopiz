...
class AlipayEbppBillAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->billKey,"billKey");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->billKey,50,"billKey");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->chargeInst,"chargeInst");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->chargeInst,80,"chargeInst");
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->mobile,"mobile");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->ownerName,50,"ownerName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->payAmount,"payAmount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->subOrderType,"subOrderType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->subOrderType,10,"subOrderType");
	}
