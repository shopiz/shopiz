...
class FavoriteAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemNumid,"itemNumid");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->itemNumid,9223372036854775807,"itemNumid");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->itemNumid,1,"itemNumid");
	}
