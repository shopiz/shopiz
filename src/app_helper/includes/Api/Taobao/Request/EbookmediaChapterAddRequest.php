...
1：更新中，3：完本，2：暂停
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->cpCid,"cpCid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->isFree,"isFree");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->preTbid,"preTbid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->priceCount,"priceCount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->status,"status");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->volumeId,"volumeId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->wordCount,"wordCount");
	}
