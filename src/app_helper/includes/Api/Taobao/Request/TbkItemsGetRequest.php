...
5goldencrown(五黄冠)
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->cid,2147483647,"cid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->fields,"fields");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageNo,10,"pageNo");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageSize,400,"pageSize");
	}
