...
2:审批拒绝
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->auditResult,"auditResult");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->remark,"remark");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->requisitionId,"requisitionId");
	}
