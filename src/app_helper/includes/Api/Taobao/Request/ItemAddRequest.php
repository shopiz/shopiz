...
<wapDesc>
   ...
   <txt>crf</txt>
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->cid,0,"cid");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->desc,"desc");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->desc,200000,"desc");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->globalStockCountry,30,"globalStockCountry");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->locationCity,"locationCity");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->locationState,"locationState");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->num,"num");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->num,900000000,"num");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->num,0,"num");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->paimaiInfoInterval,60,"paimaiInfoInterval");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->paimaiInfoInterval,1,"paimaiInfoInterval");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->paimaiInfoMode,3,"paimaiInfoMode");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->paimaiInfoMode,1,"paimaiInfoMode");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->paimaiInfoValidHour,48,"paimaiInfoValidHour");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->paimaiInfoValidHour,1,"paimaiInfoValidHour");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->paimaiInfoValidMinute,59,"paimaiInfoValidMinute");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->paimaiInfoValidMinute,0,"paimaiInfoValidMinute");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->price,"price");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->propertyAlias,511,"propertyAlias");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->sellPoint,150,"sellPoint");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->sellerCids,10,"sellerCids");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->stuffStatus,"stuffStatus");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->title,120,"title");
