...
class InventoryStoreManageRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->addressAreaName,"addressAreaName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->operateType,"operateType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->storeCode,"storeCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->storeName,"storeName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->storeType,"storeType");
	}
