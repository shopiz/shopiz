...
<pre>
{
  "SKU":
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->auctionStatus,10,"auctionStatus");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->city,"city");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->city,20,"city");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->description,"description");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->description,25000,"description");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->etcAutoRefund,100,"etcAutoRefund");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->etcAutoRefund,0,"etcAutoRefund");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->etcOverduePay,100,"etcOverduePay");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->etcOverduePay,0,"etcOverduePay");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->image1,"image1");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->listTime,20,"listTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->productId,"productId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->prov,"prov");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->prov,20,"prov");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->skus,"skus");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->subStockAtBuy,"subStockAtBuy");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->title,"title");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->title,60,"title");
	}
