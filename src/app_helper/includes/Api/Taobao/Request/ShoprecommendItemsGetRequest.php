...
<p>如果是非淘客卖家，则无法获取，暂无替代方案。</p>
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->count,"count");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->recommendType,"recommendType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sellerId,"sellerId");
	}
