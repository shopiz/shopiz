...
class LogisticsConsignOrderCreateandsendRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->companyId,"companyId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemJsonString,"itemJsonString");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->logisType,"logisType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderSource,"orderSource");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->orderType,"orderType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rAddress,"rAddress");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rAreaId,"rAreaId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rCityName,"rCityName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rName,"rName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rProvName,"rProvName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rZipCode,"rZipCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sAddress,"sAddress");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sAreaId,"sAreaId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sCityName,"sCityName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sName,"sName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sProvName,"sProvName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sZipCode,"sZipCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->tradeId,"tradeId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->userId,"userId");
	}
