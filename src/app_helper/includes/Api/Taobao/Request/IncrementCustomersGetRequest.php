...
class IncrementCustomersGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->nicks,20,"nicks");
		...
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageSize,0,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->type,3,"type");
	}
