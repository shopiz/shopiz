...
class TmallProductSpecAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->image,"image");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->labelPrice,999999999,"labelPrice");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->labelPrice,0,"labelPrice");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->productId,"productId");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->specPropsAlias,60,"specPropsAlias");
	}
