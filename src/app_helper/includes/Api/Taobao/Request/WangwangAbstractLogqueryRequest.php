...
class WangwangAbstractLogqueryRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->count,1,"count");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endDate,"endDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->fromId,"fromId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->startDate,"startDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->toId,"toId");
	}
