...
class SubuserEmployeeAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->departmentId,"departmentId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->employeeName,"employeeName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sex,"sex");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->subId,"subId");
	}
