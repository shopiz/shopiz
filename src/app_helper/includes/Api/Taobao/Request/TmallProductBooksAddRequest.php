...
2. 位数限定：13位、开头数字限定： 9787开头<br /> 支持最大长度为：13<br /> 支持的最大列表长度为：13
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->appInfo,"appInfo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->appInfo,40,"appInfo");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->author,"author");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->author,80,"author");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->authorArea,80,"authorArea");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->barCode,"barCode");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->barCode,20,"barCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->bookBind,"bookBind");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->bookBind,10,"bookBind");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->catalog,8000,"catalog");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->categoryId,"categoryId");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->categoryId,40,"categoryId");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->chinaClassifyNo,30,"chinaClassifyNo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->cip,50,"cip");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->commentator,40,"commentator");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->customId,"customId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->deputyName,"deputyName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->deputyName,150,"deputyName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->drawor,40,"drawor");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->editor,40,"editor");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->graphor,40,"graphor");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->isbn,"isbn");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->isbn,13,"isbn");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->narrator,40,"narrator");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->partName,150,"partName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->plottor,40,"plottor");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->price,"price");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->price,40,"price");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->publishCompany,80,"publishCompany");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->reginYear,10,"reginYear");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->scholisat,40,"scholisat");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->seriesBooksName,150,"seriesBooksName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->spuImg,150,"spuImg");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->summary,5000,"summary");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->translator,40,"translator");
	}
