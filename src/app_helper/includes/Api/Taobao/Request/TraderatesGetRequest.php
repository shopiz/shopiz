...
class TraderatesGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageSize,150,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageSize,1,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->rateType,"rateType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->role,"role");
	}
