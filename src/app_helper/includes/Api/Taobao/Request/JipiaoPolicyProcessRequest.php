...
2，表示按out_product_id修改政策<br /> 支持最大值为：2<br /> 支持最小值为：0
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->airline,"airline");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->airline,2,"airline");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->arrAirports,"arrAirports");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->arrAirports,100,"arrAirports");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->attributes,300,"attributes");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->cabinRules,"cabinRules");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->cabinRules,300,"cabinRules");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->changeRule,300,"changeRule");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->dayOfWeeks,"dayOfWeeks");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->dayOfWeeks,7,"dayOfWeeks");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->depAirports,"depAirports");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->depAirports,100,"depAirports");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->ei,20,"ei");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->excludeDate,200,"excludeDate");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->flags,9223372036854775807,"flags");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->flags,0,"flags");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->flightInfo,1000,"flightInfo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->memo,500,"memo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->officeId,32,"officeId");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->outProductId,64,"outProductId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->policyType,"policyType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->refundRule,300,"refundRule");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->reissueRule,300,"reissueRule");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->saleEndDate,"saleEndDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->saleStartDate,"saleStartDate");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->seatInfo,1500,"seatInfo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->specialRule,300,"specialRule");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->travelEndDate,"travelEndDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->travelStartDate,"travelStartDate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->type,"type");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->type,2,"type");
