...
单价的单位位分
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->addr,"addr");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->buyerName,"buyerName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->buyerName,20,"buyerName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->logisticFee,"logisticFee");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->logisticType,"logisticType");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->message,200,"message");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->outerId,"outerId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->payType,"payType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->province,"province");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->subOrderDetail,"subOrderDetail");
	}
