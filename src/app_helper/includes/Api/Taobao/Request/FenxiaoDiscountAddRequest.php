...
class FenxiaoDiscountAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->discountName,"discountName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->discountTypes,"discountTypes");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->discountValues,"discountValues");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->targetIds,"targetIds");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->targetTypes,"targetTypes");
	}
