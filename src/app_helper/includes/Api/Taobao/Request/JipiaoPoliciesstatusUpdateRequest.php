...
class JipiaoPoliciesstatusUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->airline,5,"airline");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->arrAirport,3,"arrAirport");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->depAirport,3,"depAirport");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->source,20,"source");
