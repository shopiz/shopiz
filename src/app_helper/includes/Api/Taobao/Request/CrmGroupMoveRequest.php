...
class CrmGroupMoveRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->fromGroupId,"fromGroupId");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->fromGroupId,1,"fromGroupId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->toGroupId,"toGroupId");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->toGroupId,1,"toGroupId");
	}
