...
class LogisticsOrdertracePushRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->companyName,"companyName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->companyName,20,"companyName");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->currentCity,20,"currentCity");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->facilityName,100,"facilityName");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->mailNo,"mailNo");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->nextCity,20,"nextCity");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->nodeDescription,20,"nodeDescription");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->occureTime,"occureTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->operateDetail,"operateDetail");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->operateDetail,200,"operateDetail");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->operatorContact,20,"operatorContact");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->operatorName,20,"operatorName");
	}
