...
class TravelItemsUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuPrices,20,"skuPrices");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuProperties,20,"skuProperties");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->skuQuantities,20,"skuQuantities");
	}
