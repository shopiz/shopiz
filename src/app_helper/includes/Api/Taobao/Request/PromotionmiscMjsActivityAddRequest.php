...
class PromotionmiscMjsActivityAddRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->decreaseAmount,0,"decreaseAmount");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->discountRate,0,"discountRate");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->endTime,"endTime");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->giftName,32,"giftName");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->itemCount,0,"itemCount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->name,"name");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->name,32,"name");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->participateRange,"participateRange");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->participateRange,1,"participateRange");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->participateRange,0,"participateRange");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->shopMemberLevel,9,"shopMemberLevel");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->shopMemberLevel,0,"shopMemberLevel");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->startTime,"startTime");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->totalPrice,0,"totalPrice");
