...
class AlipayMicropayOrderDirectPayRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->amount,"amount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->authToken,"authToken");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->memo,"memo");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->receiveUserId,"receiveUserId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->transferOutOrderNo,"transferOutOrderNo");
	}
