...
client:phone手机版本宝贝使用
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->imageInputTitle,"imageInputTitle");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->img,"img");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->pictureCategoryId,"pictureCategoryId");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pictureCategoryId,9223372036854775807,"pictureCategoryId");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pictureCategoryId,0,"pictureCategoryId");
	}
