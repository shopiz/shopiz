...
class TmcMessagesConfirmRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->fMessageIds,200,"fMessageIds");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sMessageIds,"sMessageIds");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->sMessageIds,200,"sMessageIds");
	}
