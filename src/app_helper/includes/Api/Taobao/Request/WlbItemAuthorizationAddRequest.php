...
当部分授权时，需要指定授权数量quantity
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->authType,"authType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->authorizeEndTime,"authorizeEndTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->authorizeStartTime,"authorizeStartTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->consignUserNick,"consignUserNick");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemIdList,"itemIdList");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->name,"name");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->name,255,"name");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->ruleCode,"ruleCode");
	}
