...
class SimbaCampaignBudgetUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->budget,99999,"budget");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->budget,30,"budget");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->campaignId,"campaignId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->useSmooth,"useSmooth");
	}
