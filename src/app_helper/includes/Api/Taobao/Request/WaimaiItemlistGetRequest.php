...
class WaimaiItemlistGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageNo,500,"pageNo");
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->pageSize,500,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->pageSize,1,"pageSize");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->salesStatus,"salesStatus");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->salesStatus,2,"salesStatus");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->salesStatus,0,"salesStatus");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->shopid,"shopid");
	}
