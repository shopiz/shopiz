...
class CaipiaoLotterySendRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->buyerNumId,"buyerNumId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->sellerNumId,"sellerNumId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->stakeCount,"stakeCount");
	}
