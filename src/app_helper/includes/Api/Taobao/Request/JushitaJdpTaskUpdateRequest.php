...
class JushitaJdpTaskUpdateRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->errorMessage,100,"errorMessage");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->executeHost,30,"executeHost");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->id,"id");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->nextExecuteTime,"nextExecuteTime");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->nowSyncTime,"nowSyncTime");
		\Api\Taobao\RequestCheckUtil::checkMaxLength($this->params,512,"params");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->status,"status");
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->status,2,"status");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->status,-1,"status");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->type,0,"type");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->version,"version");
	}
