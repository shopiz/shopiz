...
class CaipiaoGoodsInfoInputRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->goodsId,"goodsId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->goodsPrice,"goodsPrice");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->goodsType,"goodsType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->lotteryTypeId,"lotteryTypeId");
