...
IC_SKU--淘宝sku
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->changeCount,"changeCount");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->itemId,"itemId");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->opType,"opType");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->outBizCode,"outBizCode");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->resultCount,"resultCount");
