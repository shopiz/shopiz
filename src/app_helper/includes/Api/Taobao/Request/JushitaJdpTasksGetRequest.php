...
class JushitaJdpTasksGetRequest
{
	...
	public function check()
	{
		...
		\Api\Taobao\RequestCheckUtil::checkMaxValue($this->fetchNum,200,"fetchNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->fetchNum,1,"fetchNum");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->taskItemNum,1,"taskItemNum");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->taskItems,500,"taskItems");
		\Api\Taobao\RequestCheckUtil::checkNotNull($this->type,"type");
		\Api\Taobao\RequestCheckUtil::checkMinValue($this->type,0,"type");
		\Api\Taobao\RequestCheckUtil::checkMaxListSize($this->userIds,200,"userIds");
	}
